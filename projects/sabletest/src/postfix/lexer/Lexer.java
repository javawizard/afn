...
public class Lexer
{
            ...
            else
            {
                if (accept_state != -1)
                {
                    switch (accept_token)
                    {
                        ...
                        {
                            Token token =
                                    new0(getText(accept_length), start_line + 1,
                                            start_pos + 1);
                        ...
                        {
                            Token token =
                                    new8(getText(accept_length), start_line + 1,
                                            start_pos + 1);
                            pushBack(accept_length);
                            this.pos = accept_pos;
                            this.line = accept_line;
                ...
                else
                {
                    if (this.text.length() > 0)
                    {
                        throw new LexerException("[" + (start_line + 1) + ","
                            + (start_pos + 1) + "]" + " Unknown token: " + this.text);
                    }
    ...
    /*
     * { { // INITIAL {{10, 10, 1}, {13, 13, 2}, {32, 32, 3}, {37, 37, 4}, {40, 40, 5},
     * {41, 41, 6}, {42, 42, 7}, {43, 43, 8}, {45, 45, 9}, {47, 47, 10}, {48, 57, 11}, },
     * {{10, 32, -2}, }, {{10, 32, -2}, }, {{10, 32, -2}, }, {}, {}, {}, {}, {}, {}, {},
     * {{48, 57, 11}, }, } };
     */
    ...
    /*
     * { // INITIAL {-1, 8, 8, 8, 5, 6, 7, 3, 1, 2, 4, 0, },
     * 
     * };
     */
    ...
    static
    {
        ...
        {
            DataInputStream s =
                    new DataInputStream(new BufferedInputStream(Lexer.class
