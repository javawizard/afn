...
public class Parser
{
    ...
    private void push(int numstate, ArrayList listNode, boolean hidden)
    ...
    /*
     * { {{-1, ERROR, 0}, {0, SHIFT, 1}, {6, SHIFT, 2}, }, {{-1, REDUCE, 7}, }, {{-1,
     * ERROR, 2}, {0, SHIFT, 1}, {6, SHIFT, 2}, }, {{-1, ERROR, 3}, {1, SHIFT, 7}, {2,
     * SHIFT, 8}, {8, ACCEPT, -1}, }, {{-1, REDUCE, 0}, {3, SHIFT, 9}, {4, SHIFT, 10}, {5,
     * SHIFT, 11}, }, {{-1, REDUCE, 3}, }, {{-1, ERROR, 6}, {1, SHIFT, 7}, {2, SHIFT, 8},
     * {7, SHIFT, 12}, }, {{-1, ERROR, 7}, {0, SHIFT, 1}, {6, SHIFT, 2}, }, {{-1, ERROR,
     * 8}, {0, SHIFT, 1}, {6, SHIFT, 2}, }, {{-1, ERROR, 9}, {0, SHIFT, 1}, {6, SHIFT, 2},
     * }, {{-1, ERROR, 10}, {0, SHIFT, 1}, {6, SHIFT, 2}, }, {{-1, ERROR, 11}, {0, SHIFT,
     * 1}, {6, SHIFT, 2}, }, {{-1, REDUCE, 8}, }, {{-1, REDUCE, 1}, {3, SHIFT, 9}, {4,
     * SHIFT, 10}, {5, SHIFT, 11}, }, {{-1, REDUCE, 2}, {3, SHIFT, 9}, {4, SHIFT, 10}, {5,
     * SHIFT, 11}, }, {{-1, REDUCE, 4}, }, {{-1, REDUCE, 5}, }, {{-1, REDUCE, 6}, }, };
     */
    private static int[][][] gotoTable;
    /*
     * { {{-1, 3}, {2, 6}, }, {{-1, 4}, {7, 13}, {8, 14}, }, {{-1, 5}, {9, 15}, {10, 16},
     * {11, 17}, }, };
     */
    private static String[] errorMessages;
    /*
     * { "expecting: number, '('", "expecting: '+', '-', '*', '/', '%', ')', EOF",
    ...
    static
    {
        ...
        {
            DataInputStream s =
                    new DataInputStream(new BufferedInputStream(Parser.class
